...
<html lang="en">
<head>
    <title>Code coverage report for components/VuetablePaginationInfoMixin.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">components/</a> VuetablePaginationInfoMixin.vue
    </h1>
    <div class='clearfix'>
...
export default {
  props: {
    paginationInfoClass: <span class="fstat-no" title="function not covered" >{</span>
      type: String,
      default() {
<span class="cstat-no" title="statement not covered" >        r</span>eturn 'left floated left aligned six wide column'
      }
    },
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Dec 17 2016 14:09:52 GMT+0700 (ICT)
</div>
</div>
