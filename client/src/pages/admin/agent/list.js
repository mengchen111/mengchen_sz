...
new Vue({
  ...
  mounted: function () {
    ...
    this.$root.eventHub.$on('topUpAgentEvent', function (data) {
      _self.activatedRow = data
    })
    this.$root.eventHub.$on('editInfoEvent', function (data) {
      _self.activatedRow = data
    })
    this.$root.eventHub.$on('changeAgentPasswordEvent', function (data) {
      _self.activatedRow = data
    })
    this.$root.eventHub.$on('deleteAgentEvent', function (data) {
      _self.activatedRow = data
    })
  },
})